...
class HomeViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        // Adding and Calling Programmatic Views
...
//        mainScrollView.isPagingEnabled = true
    ...
    lazy var imageToBeScrolledNumOne: UIImageView = {
        ...
        let mainImageView = UIImageView(frame: CGRect(x: 100, y: 100, width: 210, height: 100))
    ...
    /// This closure is creating a scroll view
       lazy var imageToBeScrolledNumTwo: UIImageView = {
           ...
           let mainImageView = UIImageView(frame: CGRect(x: 500, y: 400, width: 210, height: 100))
